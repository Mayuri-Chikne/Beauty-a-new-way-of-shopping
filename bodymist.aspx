<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="bodymist.aspx.cs" Inherits="bodymist" %>
...
<table class="style6">
        <tr>
            <td class="style25" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label28" runat="server" Text="177"></asp:Label>
                &nbsp;</td>
            <td style="font-size: xx-large">
                &nbsp;prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label29" runat="server" Text="178"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style25" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label33" runat="server" Text="armaf body mist for girls"></asp:Label>
            </td>
            <td style="font-size: xx-large">
                <asp:Label ID="Label32" runat="server" Text="mama earth body mist"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style8" style="font-size: xx-large">
                ...
                <asp:ImageButton ID="ImageButton9" runat="server" Height="300px" 
                    ImageUrl="~/image/perfume/bodymist/bodymist1.jpg" Width="400px" />
            ...
            <td class="style9" style="font-size: xx-large"> 
                ...
                <asp:ImageButton ID="ImageButton10" runat="server" Height="300px" 
                    ImageUrl="~/image/perfume/bodymist/bodymist2.jpg" Width="400px" />
        ...
        <tr>
            <td class="style25" style="font-size: xx-large">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label17" runat="server" Font-Size="Larger" Text="rs990"></asp:Label>
            </td>
            <td style="font-size: xx-large">
        <asp:Label ID="Label22" runat="server" Font-Size="Larger" Text="rs300"></asp:Label>
            </td>
        </tr>
        <tr>
    ...
    <p>
        ...
        <tr>
            <td class="style25" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <asp:Label ID="Label30" runat="server" Text="179"></asp:Label>
                &nbsp;</td>
            <td style="font-size: xx-large">
                &nbsp;prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label31" runat="server" Text="180"></asp:Label>
            </td>
        </tr>
        
            <td class="style25" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label35" runat="server" Text="black musk body mist for girls"></asp:Label>
        </td>
            <td style="font-size: xx-large">
                <asp:Label ID="Label34" runat="server" Text="surety for safety body mist for girls"></asp:Label>
        </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style25" style="font-size: xx-large">
                ...
                <asp:ImageButton ID="ImageButton7" runat="server" Height="300px" 
                    ImageUrl="~/image/perfume/bodymist/bodymist3.jpg" Width="400px" />
                
               
            </td>
            <td style="font-size: xx-large">
                <asp:ImageButton ID="ImageButton8" runat="server" Height="300px" 
                    ImageUrl="~/image/perfume/bodymist/bodymist4.jpg" Width="400px" 
        ...
        <tr>
            <td class="style25" style="font-size: xx-large">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label19" runat="server" Font-Size="Larger" Text="rs2400"></asp:Label>
            </td>
            <td style="font-size: xx-large">
        <asp:Label ID="Label24" runat="server" Font-Size="Larger" Text="rs280"></asp:Label>
                &nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td class="style25" style="font-size: xx-small">
