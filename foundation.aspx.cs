...
public partial class foundation : System.Web.UI.Page
{
    ...
    protected void Button25_Click(object sender, EventArgs e)
    {
        SqlConnection cn = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\91830\Documents\customerinfo.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True");
        cn.Open();
        SqlCommand cmd = new SqlCommand("insert  into addtocart values('" + Label30.Text + "','" + Label34.Text + "','" + Label19.Text + "','" + ImageButton4.ImageUrl + "')", cn);
        cmd.ExecuteNonQuery();
        cn.Close();
        Response.Write("<script>alert('Added to Cart Sucessfully');</script>");
    }
    protected void Button27_Click(object sender, EventArgs e)
    {
        SqlConnection cn = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\91830\Documents\customerinfo.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True");
        cn.Open();
        SqlCommand cmd = new SqlCommand("insert  into addtocart values('" + Label31.Text + "','" + Label35.Text + "','" + Label24.Text + "','" + ImageButton5.ImageUrl + "')", cn);
        cmd.ExecuteNonQuery();
        cn.Close();
        Response.Write("<script>alert('Added to Cart Sucessfully');</script>");
    }
