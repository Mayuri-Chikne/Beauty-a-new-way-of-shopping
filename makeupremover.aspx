<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="makeupremover.aspx.cs" Inherits="makeupremover" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        &nbsp;</p>  <table class="style6">
        <tr>
            <td class="style7" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label28" runat="server" Text="121"></asp:Label>
            </td>
            <td style="font-size: xx-large">
                &nbsp;prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label29" runat="server" Text="122"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style7" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label 
                    ID="Label32" runat="server" Text=" Miracle&nbsp; Makeup Remover"></asp:Label>
            </td>
            <td style="font-size: xx-large">
                <asp:Label ID="Label33" runat="server" Text="Faces Canada&nbsp; Makeup Remover"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
                ...
                <asp:ImageButton ID="ImageButton2" runat="server" Height="300px" 
                    ImageUrl="~/image/face/makeupremover/remover1.jpg" Width="400px" />
                
               
            </td>
            <td class="style9" style="font-size: xx-large"> 
                <asp:ImageButton ID="ImageButton6" runat="server" Height="300px" 
                    ImageUrl="~/image/face/makeupremover/remover2.jpg" Width="400px" />
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label17" runat="server" Font-Size="Larger" Text="rs400"></asp:Label>
            </td>
            <td style="font-size: xx-large">
        <asp:Label ID="Label22" runat="server" Font-Size="Larger" Text="rs220"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style7" style="font-size: xx-small">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td class="style8" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <asp:Label ID="Label30" runat="server" Text="123"></asp:Label>
                &nbsp;</td>
            <td style="font-size: xx-large" class="style6">
                &nbsp;prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label31" runat="server" Text="124"></asp:Label>
                </td>
        </tr>
        
            <td class="style7" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label35" runat="server" Text="Make up&nbsp; Eraser"></asp:Label>
        </td>
            <td style="font-size: xx-large">
                <asp:Label ID="Label34" runat="server" Text="Colorbar Makeup Remover"></asp:Label>
        </td>
        </tr>
        <tr>
            <td class="style7" style="font-size: xx-small">
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
                ...
                <asp:ImageButton ID="ImageButton7" runat="server" Height="300px" 
                    ImageUrl="~/image/face/makeupremover/remover3.jpg" Width="400px" />
                
               
            </td>
            <td style="font-size: xx-large">
                <asp:ImageButton ID="ImageButton8" runat="server" Height="300px" 
                    ImageUrl="~/image/face/makeupremover/remover4.jpg" Width="400px" />
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label19" runat="server" Font-Size="Larger" Text="rs1350"></asp:Label>
            </td>
            <td style="font-size: xx-large">
