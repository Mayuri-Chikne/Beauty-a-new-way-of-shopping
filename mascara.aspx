<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="mascara.aspx.cs" Inherits="mascara" %>
...
<table class="style6">
        <tr>
            <td class="style7" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label31" runat="server" Text="133"></asp:Label>
            </td>
            <td style="font-size: xx-large">
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label32" runat="server" Text="134"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style7" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label35" runat="server" Text="royal blue matte Mascara"></asp:Label>
            </td>
            <td style="font-size: xx-large">
                <asp:Label ID="Label36" runat="server" Text="Mascara waterproof (black)"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
                ...
                <asp:ImageButton ID="ImageButton2" runat="server" Height="300px" 
                    ImageUrl="~/image/eye/mascara/mascara1.jpg" Width="400px" />
                
               
            </td>
            <td class="style9" style="font-size: xx-large"> 
                <asp:ImageButton ID="ImageButton6" runat="server" Height="300px" 
                    ImageUrl="~/image/eye/mascara/mascara2.jpg" Width="400px" />
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label17" runat="server" Font-Size="Larger" Text="rs300"></asp:Label>
            </td>
            <td style="font-size: xx-large">
        <asp:Label ID="Label22" runat="server" Font-Size="Larger" Text="rs280"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style7" style="font-size: xx-small">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label33" runat="server" Text="135"></asp:Label>
                &nbsp;</td>
            <td style="font-size: xx-large">
                prouduct id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label34" runat="server" Text="136"></asp:Label>
            </td>
        </tr>
        
            <td class="style7" style="font-size: xx-large">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label37" runat="server" Text="maybelline Mascara (black)"></asp:Label>
        </td>
            <td style="font-size: xx-large">
                <asp:Label ID="Label38" runat="server" Text="kiss beauty Mascara "></asp:Label>
        </td>
        </tr>
        <tr>
            <td class="style7" style="font-size: xx-small">
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
                ...
                <asp:ImageButton ID="ImageButton7" runat="server" Height="300px" 
                    ImageUrl="~/image/eye/mascara/mascara3.jpg" Width="400px" />
                
               </td>
          <td style="font-size: xx-large">
                <asp:ImageButton ID="ImageButton8" runat="server" Height="300px" 
                    ImageUrl="~/image/eye/mascara/mascara4.jpg" Width="400px" />
        ...
        <tr>
            <td class="style7" style="font-size: xx-large">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label19" runat="server" Font-Size="Larger" Text="rs300"></asp:Label>
            </td>
            <td style="font-size: xx-large">
        <asp:Label ID="Label24" runat="server" Font-Size="Larger" Text="rs100"></asp:Label>
                &nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td class="style7" style="font-size: xx-small">
